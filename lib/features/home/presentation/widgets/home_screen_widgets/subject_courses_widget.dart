...
class SubjectCoursesWidget extends StatelessWidget {
  const SubjectCoursesWidget({super.key});
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) => Padding(
              ...
              child: SubjectCourseListItemWidget(
...
class SubjectCourseListItemWidget extends StatelessWidget {
  final Map<String, String> lesson;
  const SubjectCourseListItemWidget({super.key, required this.lesson});
