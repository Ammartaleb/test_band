...
class PhoneNumberInputFieldWidget extends StatefulWidget {
  final TextEditingController textEditingController;

  const PhoneNumberInputFieldWidget({
    super.key,
    required this.textEditingController,
  });

  @override
  State<PhoneNumberInputFieldWidget> createState() =>
      _PhoneNumberInputFieldWidgetState();
}

class _PhoneNumberInputFieldWidgetState
    extends State<PhoneNumberInputFieldWidget> {
  final prefix = "+964";
  @override
  void initState() {
