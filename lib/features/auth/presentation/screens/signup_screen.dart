...
import 'package:test_band/features/auth/presentation/widgets/signup_screen_widgets/signup_screen_content_widget.dart';
    ...
    return Scaffold(
      body: ArabicLayoutWidget(
        child: NestedScrollView(
          ...
          body: const SignupScreenContentWidget(),
        ),
      ),
    );
  }
